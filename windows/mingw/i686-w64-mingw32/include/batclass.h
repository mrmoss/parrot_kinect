...
typedef NTSTATUS (*PBCLASS_QUERY_TAG_CALLBACK)(PVOID Context,PULONG BatteryTag);
typedef NTSTATUS (*PBCLASS_QUERY_INFORMATION_CALLBACK)(PVOID Context,ULONG BatteryTag,BATTERY_QUERY_INFORMATION_LEVEL Level,LONG AtRate,PVOID Buffer,ULONG BufferLength,PULONG ReturnedLength);
typedef NTSTATUS (*PBCLASS_QUERY_STATUS_CALLBACK)(PVOID Context,ULONG BatteryTag,PBATTERY_STATUS BatteryStatus);
typedef NTSTATUS (*PBCLASS_SET_STATUS_NOTIFY_CALLBACK)(PVOID Context,ULONG BatteryTag,PBATTERY_NOTIFY BatteryNotify);
typedef NTSTATUS (*PBCLASS_SET_INFORMATION_CALLBACK)(PVOID Context,ULONG BatteryTag,BATTERY_SET_INFORMATION_LEVEL Level,PVOID Buffer);
typedef NTSTATUS (*PBCLASS_DISABLE_STATUS_NOTIFY_CALLBACK)(PVOID Context);
...
#define BATTERY_CLASS_MAJOR_VERSION 0x1
#define BATTERY_CLASS_MINOR_VERSION 0x0
