...
#define __IReplica_INTERFACE_DEFINED__
  ...
  public:
    ...
    virtual HRESULT WINAPI get_Priority(__LONG32 *pl) = 0;
    virtual HRESULT WINAPI get_ReplicaId(VARIANT *pvar) = 0;
    virtual HRESULT WINAPI get_ReplicaType(ReplicaTypeEnum *pl) = 0;
    virtual HRESULT WINAPI get_RetentionPeriod(__LONG32 *pl) = 0;
    virtual HRESULT WINAPI put_RetentionPeriod(__LONG32 l) = 0;
    virtual HRESULT WINAPI get_Visibility(VisibilityEnum *pl) = 0;
    virtual HRESULT WINAPI CreateReplica(BSTR replicaName,BSTR description,ReplicaTypeEnum replicaType = jrRepTypeFull,VisibilityEnum visibility = jrRepVisibilityGlobal,__LONG32 priority = -1,UpdatabilityEnum updatability = jrRepUpdFull) = 0;
  ...
  typedef struct IReplicaVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Priority)(IReplica *This,__LONG32 *pl);
      HRESULT (WINAPI *get_ReplicaId)(IReplica *This,VARIANT *pvar);
      HRESULT (WINAPI *get_ReplicaType)(IReplica *This,ReplicaTypeEnum *pl);
      HRESULT (WINAPI *get_RetentionPeriod)(IReplica *This,__LONG32 *pl);
      HRESULT (WINAPI *put_RetentionPeriod)(IReplica *This,__LONG32 l);
      HRESULT (WINAPI *get_Visibility)(IReplica *This,VisibilityEnum *pl);
      HRESULT (WINAPI *CreateReplica)(IReplica *This,BSTR replicaName,BSTR description,ReplicaTypeEnum replicaType,VisibilityEnum visibility,__LONG32 priority,UpdatabilityEnum updatability);
...
#define IReplica_get_Filters(This,ppFilters) (This)->lpVtbl->get_Filters(This,ppFilters)
  ...
  HRESULT WINAPI IReplica_get_Priority_Proxy(IReplica *This,__LONG32 *pl);
  ...
  HRESULT WINAPI IReplica_get_RetentionPeriod_Proxy(IReplica *This,__LONG32 *pl);
  ...
  HRESULT WINAPI IReplica_put_RetentionPeriod_Proxy(IReplica *This,__LONG32 l);
  ...
  HRESULT WINAPI IReplica_CreateReplica_Proxy(IReplica *This,BSTR replicaName,BSTR description,ReplicaTypeEnum replicaType,VisibilityEnum visibility,__LONG32 priority,UpdatabilityEnum updatability);
...
#define __Filters_INTERFACE_DEFINED__
  ...
  typedef struct FiltersVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Count)(Filters *This,__LONG32 *c);
...
#define Filters_Delete(This,Index) (This)->lpVtbl->Delete(This,Index)
  ...
  HRESULT WINAPI Filters_get_Count_Proxy(Filters *This,__LONG32 *c);
