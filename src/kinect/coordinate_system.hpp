...
#define kcs_kinect_offset vec3(0.3,0.0,0.0)

//Size of viewable field (full size of field, not 1/2 or 1/4 or distance+1/2 of...)
#define kcs_x_field_size 2.5//3.1
#define kcs_y_field_size 1.75//1.75
#define kcs_z_field_size 1//3.5
#define kcs_buffer 0.3

//Distance FROM kinect to edge of field
#define kcs_distance_from_kinect 1.5//3.0
